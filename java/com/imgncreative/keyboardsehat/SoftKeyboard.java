...
//    private CandidateView mCandidateView;
    ...
    private Keyboard mQwertyKeyboardUp;

    private String mWordSeparators;

    List<String> itemList = new ArrayList<String>();
    List<String> itemAccu = new ArrayList<String>();
    Adapter adapter;
    DBHelper SQLite = new DBHelper(this);
    ArrayList<Character> myListText = new ArrayList<Character>();
    ...
    private void makeKeyboards() {
        ...
        mQwertyKeyboardUp = new LatinKeyboard(this, R.xml.qwertyup);
    ...
    public View onCreateInputView() {
        makeKeyboards();
        mInputView = (KeyboardView) getLayoutInflater().inflate(R.layout.keyboard_view, null);
...
//        mCandidateView.setService(this);
    ...
    public boolean checkBannedText1(String text){

        boolean checkText = false;
        ArrayList<String> data_kotor = new ArrayList<String>();
        ArrayList<String> data_akurasi = new ArrayList<String>();

        data_kotor = (ArrayList<String>) itemList;
        data_akurasi = (ArrayList<String>) itemAccu;
        Log.d(TAG, "data_kotor: "+data_kotor);
        Log.d(TAG, "data_akurasi: "+data_akurasi);
        ...
        for (int i = 0; i < data_kotor.size(); i++)
        {
            ...
            System.out.println("");
            Log.d(TAG, "BAN_LIST: "+data_kotor.get(i));
        ...
        if (!limit) {
            System.out.println("Gak ono bos!");
        }else{
            checkText = true;
        }

        if (checkText==true){
            Log.d(TAG, "myListTextBanned: "+ban_chosen+" ==> "+mComposing);
            permit = true;
            myListText.clear();
        }
...
//            updateCandidates();
    ...
    private void dismissSoftInput(int i) {
